...
<div class="3u">
    <div class="sidebar">
        ...
        <!-- Recent Posts -->
        <section>
            <h3 class="major"><span>Sveiki, <?php echo $user->nick_name; ?></span></h3>
            <ul class="style2">
                <li>
                    <article class="is-post-summary">
                        <a href="#" class="image image-full"><img src="<?php echo $user->pic_url; ?>" alt="" /></a>
                    </article>
                </li>
                <li>
                    <article class="is-post-summary">
                        <h3><a href="#">Profila labošana</a></h3>
                        <ul class="meta">
